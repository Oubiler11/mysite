from src.pages.yidongkucun.caigoushouhuodan import yidongkucun_cgshd_a1_login,yidongkucun_cgshd_a2_zancun_guolv,yidongkucun_cgshd_a5_zancun_shanchu,\
    yidongkucun_cgshd_a6_zancun_baocun,yidongkucun_cgshd_a7_zancun_tijiao
...
class TestLong7(unittest.TestCase):
    ...
    def test_case_7(self):
        ...
        #暂存订单的详情页点击提交按钮
        self.tijiao.click_cgshd_zancun_dingdan_tijiao()
        self.assertEqual(self.tijiao.dy_cgshd_zancun_dingdan_tijiao, 1, '断言失败，提交按钮，点击失败')

        #暂存订单的详情页点击审核按钮
        self.tijiao.click_cgshd_zancun_dingdan_shenhe()
        self.assertEqual(self.tijiao.dy_cgshd_zancun_dingdan_shenhe, 1, '断言失败，审核按钮，点击失败')
