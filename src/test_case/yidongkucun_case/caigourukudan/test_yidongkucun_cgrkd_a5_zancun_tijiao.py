...
class TestLong5(unittest.TestCase):
    ...
    def test_case_5(self):
        ...
        self.assertEqual(self.tijiao.dy_cgrk_shouye_zancun_baocun, 1, '断言失败，保存按钮点击失败')
        ...
        #如果查询不成功，判断为失败
            ...
            self.assertEqual(self.login.dy_no_cgrk_yingyong_zancuntubiao, 1, '断言失败，test_case_5执行失败！')
